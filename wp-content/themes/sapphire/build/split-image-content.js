/******/ (function () {
  ...
  \*****************************************/
			/***/ function (
				...
				/* harmony import */ var _MediaUploadNoImage__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ./MediaUploadNoImage */ './blocks/components/MediaUploadNoImage.js'
					);
				/* harmony import */ var _MediaUploadWithImage__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(
						/*! ./MediaUploadWithImage */ './blocks/components/MediaUploadWithImage.js'
					);
				...
				const AdminImage = (_ref) => {
					...
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload,
						{
							allowedTypes: ['image'],
							...
							render: (_ref2) => {
								...
								_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
									...
									image
										? (0,
										  _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
												_MediaUploadWithImage__WEBPACK_IMPORTED_MODULE_3__[
													'default'
												],
												{
													image: image,
										...
										: (0,
										  _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
												_MediaUploadNoImage__WEBPACK_IMPORTED_MODULE_2__[
													'default'
												],
												{
													openMedia: open,
  ...
  \*************************************************/
			/***/ function (
				...
				const MediaUploadNoImage = (_ref) => {
					...
					return (0,
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUploadCheck,
						null,
						(0,
						_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							'div',
  ...
  \***************************************************/
			/***/ function (
				...
				const MediaUploadWithImage = (_ref) => {
					let { image, openMedia, setAttributes } = _ref;
					return (0,
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUploadCheck,
						null,
  ...
  \********************************************/
			/***/ function (
				...
				/* harmony import */ var _components_AdminImage__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ../components/AdminImage */ './blocks/components/AdminImage.js'
					);
				...
				const Edit = (_ref) => {
					...
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						...
						(0,
						_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							_components_AdminImage__WEBPACK_IMPORTED_MODULE_2__[
								'default'
							],
							{
  ...
  \***********************************************************/
		...
		/* harmony import */ var _Edit__WEBPACK_IMPORTED_MODULE_1__ =
			__webpack_require__(
				/*! ./Edit */ './blocks/split-image-content/Edit.js'
			);

		(0, _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(
			'sapphiretheme/split-image-content',
			{
